            ...
            <div className="flex gap-2">
                {isPublished && (
                    <button
                        ...
                        className="px-3 py-1 text-xs border border-yellow-300 bg-yellow-50 text-yellow-700 font-bold rounded hover:bg-yellow-100"
                    >
                        Revert to Draft
                    </button>
                )}
                ...
                {!isPublished && (
                    <button
                        ...
                        className="px-3 py-1 text-xs border border-green-300 bg-green-50 text-green-700 font-bold rounded hover:bg-green-100"
                    >
                        Publish Course
                    </button>
                )}
