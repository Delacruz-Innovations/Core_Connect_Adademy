...
import { ArrowLeft, Check, Save, Plus, Trash2, Upload, X, Eye } from 'lucide-react';
...
export default function CourseCreatePage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await showAlert(`Course "${data.title}" created successfully!`, "Success", "success");
            navigate(`/admin/courses/${data.id}`);

        } catch (error) {
            await showAlert('Error creating course: ' + error.message, 'Creation Failed', 'error');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="mx-auto py-8 max-w-5xl">
            {loading && <BrandedLoader message="Creating Course Entity..." />}
            ...
            <form onSubmit={handleSubmit} className="bg-white border border-gray-100 rounded-xl p-8 shadow-sm space-y-10">
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="md:col-span-2">
                            ...
                            <p className="text-[10px] text-gray-400 mt-1 uppercase font-bold tracking-tight italic">Warning: Slugs cannot be changed easily after creation.</p>
                        </div>
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="Brief overview for search cards..."
                                />
                            </div>
                        </div>
                    </div>
                ...
                <div className="pt-10 border-t border-gray-100 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 border border-gray-100 rounded-xl">
                        ...
                        />
                        <label htmlFor="is_published" className="text-xs font-black uppercase text-gray-600 cursor-pointer">Publish immediately</label>
                    </div>
                </div>
